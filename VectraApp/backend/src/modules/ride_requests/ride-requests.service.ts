...
export class RideRequestsService {
    ...
    async createRequest(userId: string, dto: CreateRideRequestDto): Promise<RideRequestEntity> {
    ...
    async getActiveRequestForUser(userId: string): Promise<RideRequestEntity | null> {
