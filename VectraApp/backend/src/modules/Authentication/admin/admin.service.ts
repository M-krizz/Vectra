...
export class AdminService {
    constructor(
        ...
        @InjectRepository(DriverProfileEntity) private driverRepo: Repository<DriverProfileEntity>,
        @InjectRepository(AdminAuditEntity) private auditRepo: Repository<AdminAuditEntity>,
    ) { }
