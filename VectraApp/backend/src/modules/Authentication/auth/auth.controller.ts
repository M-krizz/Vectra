...
import { RequestOtpDto, VerifyOtpDto, LoginDto, RefreshDto } from './dto/auth.dto';
...
export class AuthController {
    ...
    refresh(
        ...
        return this.authService.rotateRefreshToken(dto.refreshToken, tokenId, userAgent, ip);
    }
