...
async function runMigration() {
  try {
    ...
    try {
      ...
      console.error('Error updating status enum:', e);
    }
    ...
    try {
      ...
      console.error('Error creating vehicle_type_enum:', e);
    }
    ...
    try {
      ...
      console.error('Error creating pool_groups_status_enum:', e);
    }
    ...
    try {
      ...
      console.error('Error creating pool_groups table:', e);
    }

    try {
      // Check column existence before adding
      await queryRunner.query(
        `ALTER TABLE "ride_requests" ADD COLUMN IF NOT EXISTS "vehicle_type" "public"."vehicle_type_enum" NOT NULL DEFAULT 'AUTO'`,
      );
      console.log('Added vehicle_type column');
    } catch (e) {
      console.error('Error adding vehicle_type:', e);
    }
    ...
    try {
      ...
      console.error('Error adding pool_group_id:', e);
    }
    ...
    try {
      ...
      console.error('Error adding FK:', e);
    }
